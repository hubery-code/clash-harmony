...
具体可参考[示例代码](https://gitcode.com/HarmonyOS_Samples/paymentkit-sample-code-serverdemo-java)引入华为支付提供[Maven依赖（pay-java）](../../guides/云侧服务准备.md#集成maven依赖)中SignStringUtil.java类的signString方法，排序拼接结果示例如下：
```ets
...
SHA256WithRSA/PSS： 具体可参考[示例代码](https://gitcode.com/HarmonyOS_Samples/paymentkit-sample-code-serverdemo-java)引入华为支付提供[Maven依赖（pay-java）](../../guides/云侧服务准备.md#集成maven依赖)中RSAUtils.java类的signByRSAWithPSS方法。

SM2： 具体可参考[Maven依赖（pay-java）](../../guides/云侧服务准备.md#集成maven依赖)中Sm2Utils.java类中的sign方法。
...
使用SM2算法进行验签，具体参考[示例代码](https://gitcode.com/HarmonyOS_Samples/paymentkit-sample-code-serverdemo-java)引入华为支付提供[Maven依赖（pay-java）](../../guides/云侧服务准备.md)中VerifyTools.java类的verifySign方法。
